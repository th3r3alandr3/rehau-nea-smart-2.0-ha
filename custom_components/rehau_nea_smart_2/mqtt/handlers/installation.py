...
from ..types.installation import Installation
from ..utils.helpers import (parse_operating_mode, get_global_energy_level, save_as_json)
...
def parse_installations(installations) -> list[Installation]:
    installations_data = [{
        ...
        "operating_mode": parse_operating_mode(installation["user"]["heatcool_auto_01"]),
        "groups": [{
            "id": group["_id"],
